...
begin
  ...
  Recorder := sfSoundRecorder_create(sfSoundRecorderStartCallback(@OnStart), sfSoundRecorderProcessCallback(@OnProcess),
    sfSoundRecorderStopCallback(@OnStop), nil);
