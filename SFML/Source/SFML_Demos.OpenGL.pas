...
begin
  ...
  Window := sfRenderWindow_create(Mode, Title.ToPAnsiChar, sfUint32(sfDefaultStyle), @ContextSettings);
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, sfImage_getSize(Image).x, sfImage_getSize(Image).y, 0, GL_RGBA, GL_UNSIGNED_BYTE,
